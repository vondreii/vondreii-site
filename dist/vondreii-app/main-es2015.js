...
module.exports = JSON.parse("[{\"title\":\"Building A Second Brain With Notion: Storing Everything You Know In One Place\",\"date\":\"12 Feb 2021\",\"link\":\"/posts/buildingASecondBrainWithNotion\",\"tags\":\"Organisation\",\"description\":\"A Second Brain is simply just a single place where you store the things you know and learn. Whatever you store depends entirely on you and is based on what things add value to your life. Before, I was mostly relying on my brain to remember everything I knew or any new information I had learnt. If I did need to write things down, I would store information in many different places...\"},{\"title\":\"Hosting A Hugo App Using Netlify and Github\",\"date\":\"4 Jan 2021\",\"link\":\"/posts/hostingAHugoAppUsingNetlifyAndGithub\",\"tags\":\"Hugo • Netlify\",\"description\":\"Netlify is a free hosting platform where you can host your website live for free. One way it can do this is by linking to an existing Github repository and hosting your code stored there. If you have a Hugo App stored on a repository, you can use Netlify to host it. All you have to do is buy your own custom domain name and link it to Netlify...\"},{\"title\":\"Creating Your Own Blog Using Hugo\",\"date\":\"27 Nov 2020\",\"link\":\"/posts/createYourOwnBlogUsingHugo\",\"tags\":\"Hugo\",\"description\":\"Hugo is a framework where you can create your own website, completely from scratch without much effort or without knowing too much (or any) of the internal programming. There are also many web hosting platforms that can easily host a Hugo project for free - meaning, the only money you will spend will be for the custom domain name...\"},{\"title\":\"Creating a list of posts using Markdown on your Angular Website\",\"date\":\"11 Oct 2020\",\"link\":\"/posts/creatingAListOfPostsUsingMarkdownOnYourAngularWebsite\",\"tags\":\"Angular • Markdown\",\"description\":\"Let's say you want to write your own personal posts (for something like a blog, for example), and compile them as a list of posts on your homepage. If you want to do this yourself without using existing platforms, a good way is to use Markdown files! The basic idea is that each post or page with content will have their own file...\"},{\"title\":\"Linking A Namecheap Domain To Firebase\",\"date\":\"4 Oct 2020\",\"link\":\"/posts/linkingANamecheapDomainToFirebase\",\"tags\":\"Hosting • Firebase • Namecheap\",\"description\":\"Assuming you already have a website hosted on Firebase, you might not be satisfied with the default free domain name (which ends in something like .firebaseapp.com or .web.app). If you've already bought a Namecheap domain name, this is how you can link it to your Firebase hosted website...\"},{\"title\":\"Hosting An Angular App On Firebase\",\"date\":\"3 Oct 2020\",\"link\":\"/posts/hostingAnAngularAppOnFirebase\",\"tags\":\"Angular • Hosting • Firebase\",\"description\":\"If you already have an Angular Project set up, you might want to host it on a domain like http://www.mywebsite.web.app. Assuming you already have an Angular project coded up, we will go through step by step how to creating a project on Firebase (for your app), connect your Angular app to the Firebase Project and host your website...\"},{\"title\":\"Creating A Calculator in C#\",\"date\":\"26 Sept 2020\",\"link\":\"/posts/creatingACalculatorInCSharp\",\"tags\":\"C#\",\"description\":\"We are going to give you a step-by-step guide on how you can make your very own calculator application (complete with an executable file for the program!) This tutorial is separated into 3 sections: Part 1 covers creating the interface for the calculator. We are going to be using Visual Studio's C# Windows Forms to add buttons to the calculator. Part 2 covers adding in the basic functionality to the calculator (adding, subtracting, all of that calculator stuff). Part 3 will go through handling any invalid inputs and runtime exceptions. We will also 'finalise' the calculator...\"}]");
...
module.exports = JSON.parse("[{\"title\":\"3D Street Racing Game\",\"date\":\"2019\",\"link\":\"streetRacingGame\",\"tags\":\"3D • Game • Research • Racing\",\"description\":\"This is a modified version of the street racing game sourced from this Microsoft's Github repository. The original game is a 3D street racing game where the player must avoid the obstacles on the road...\"},{\"title\":\"CyanX\",\"date\":\"2018\",\"link\":\"cyanX\",\"tags\":\"2D • Game • Side scroller • Puzzle\",\"description\":\"A 2D platformer game set in the distant future. Solve puzzles, level up, craft weapons and defeat enemies in order to rescue captured animals...\"},{\"title\":\"Ice Capades\",\"date\":\"2015\",\"link\":\"iceCapades\",\"tags\":\"2D • Game • Top-Down • Puzzle\",\"description\":\"Ice Capades is a Pokemon-style inspired game that aims to teach players about the affects of climate change on the environment. You must pass through multiple levels, interact with objects, solve puzzles...\"}]");
