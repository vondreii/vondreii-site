...
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/github-home.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/Email-was-verified.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/main-github-dashboard.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/create-repo-settings.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/clone.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/clone2.PNG" loading="lazy" alt="image" class="image-full"/>
	<div class="image-description"><p>Cloning the repository</p></div>
</div>
<!-- ----------------------------- -->
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/git-clone-local.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/local-folder-created.PNG" loading="lazy" alt="image" class="image"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/Add-file-to-local-repo.PNG" loading="lazy" alt="image" class="image"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/cmd-commands.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/data/posts/images/settingUpASimpleGithubRemoteAndLocalRepository/pushed-code.PNG" loading="lazy" alt="image" class="image-full"/>
	<div class="image-description"><p>Run commands to store the files on the remote repository</p></div>
</div>
<!-- ----------------------------- -->
