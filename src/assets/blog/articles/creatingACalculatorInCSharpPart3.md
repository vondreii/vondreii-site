...
<div class="image-container">
    <img src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/runtime_error.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/error_message.PNG" loading="lazy" alt="image" class="image"/>
...
<div class="image-container">
    ...
    <source src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/with-error-handling.mp4" loading="lazy" type="video/mp4">
    </video>
</div>
<!-- ----------------------------- -->
...
<div class="image-container">
    <video controls="true" preload="none" allowfullscreen="true" poster="./assets/blog/images/calculator/calc-preview.png" class="image">
    <source src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/twice_equals.mp4" loading="lazy" type="video/mp4">
    </video>
</div>
<!-- ----------------------------- -->
...
<div class="image-container">
    <video controls="true" preload="none" allowfullscreen="true" poster="./assets/blog/images/calculator/calc-preview.png" class="image">
    <source src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/twice_equals_fixed.mp4" loading="lazy" type="video/mp4">
    </video>
</div>
<!-- ----------------------------- -->
...
I found some free icons at [icons-icons.com](https://icon-icons.com/search/icons/?filtro=calculator). Feel free to choose any icon you like. Make sure you select to download the **.ico** format. The one I'm using is [this one](../../assets/downloads/blog/Icon.zip).
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/icon1.PNG" loading="lazy" alt="image" class="image-full"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/icon2.PNG" loading="lazy" alt="image" class="image-full"/>
	<div class="image-description"><p>Changing the icon</p></div>
</div>
<!-- ----------------------------- -->
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/icon3.PNG" loading="lazy" alt="image" class="image-full"/>
	<div class="image-description"><p>Changing the icon</p></div>
</div>
<!-- ----------------------------- -->
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/build.PNG" loading="lazy" alt="image" class="image"/>
...
<!-- ----------- Image ----------- -->
<div class="image-container">
    <img src="./assets/blog/images/calculator/creatingACalculatorInCSharpPart3/exe.PNG" loading="lazy" alt="image" class="image"/>
